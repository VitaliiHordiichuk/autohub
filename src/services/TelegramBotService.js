      ...
      if (message?.contact && message?.chat?.id && message?.from?.id) {
        ...
        const copy = {
          uk:verification.verified
            ...
            : "Ой, цей номер не збігається з номером у вашому акаунті AutoHub. Перевірте номер у профілі або поділіться власним контактом.",
          en:verification.verified
            ? "✅ Phone number confirmed. You can now send VIN requests and chat with a manager."
            : "This number does not match the phone number in your AutoHub account. Check your profile number or share your own contact.",
          ru:verification.verified
            ? "✅ Номер подтверждён. Теперь можно отправлять VIN-запросы и общаться с менеджером."
            : "Ой, этот номер не совпадает с номером в вашем аккаунте AutoHub. Проверьте номер в профиле или поделитесь своим контактом.",
        };
