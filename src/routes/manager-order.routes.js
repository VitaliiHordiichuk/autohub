...
import { createOrderReturn, confirmOrderReturn, getOrderReturns } from "../controllers/manager-order-return.controller.js";
...
managerOrderRouter.get("/returns", getOrderReturns);
